...
export function apply(ctx, config) {
   ...
   *  event log (`current(session.events)`). Probed per service instance —
  ...
  const runningPresetOf = ({ header, events }) => {
